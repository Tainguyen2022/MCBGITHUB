...
// Import Default Data for DataSectionEditor
// This is a large block of imports that remains the same...
...
import { scenariosData as defaultScenarios } from '../data/scenariosData';
import { defaultTipsData } from '../data/tipsData';
import { units as defaultGrammarUnits } from '../data/units';
import { groups as defaultGrammarGroups } from '../data/groups';
import { vocab as defaultGrammarVocab } from '../data/vocab';
...
const dataSections = [
    ...
    // FIX: Corrected the storage key to match the one defined in `constants.ts`.
