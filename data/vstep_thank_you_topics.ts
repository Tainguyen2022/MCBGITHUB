...
export const vstepThankYouTopics: WritingSeed[] = [
    {
        id: 'VSTEP-THX-01',
...
III. Kết thúc: Nhắc lại lời cảm ơn và cam kết tương lai`,
        practice: {
            reorder: [
                ...
                {
                    words: [
                        { en: 'This generous support', vi: 'Sự hỗ trợ hào phóng này' },
                        { en: 'will significantly', vi: 'sẽ đáng kể' },
                        { en: 'ease the burden', vi: 'giảm gánh nặng' },
                        { en: 'of my studies.', vi: 'của việc học.' }
                    ],
                    answer: 'This generous support will significantly ease the burden of my studies.'
                }
            ],
            fill_blank: [
                {
                ...
                {
                    sentence: { en: 'This scholarship represents more than just ____ assistance.', vi: 'Học bổng này không chỉ là sự hỗ trợ ____.' },
                    missing_word: 'financial',
                    options: ['financial', 'academic', 'personal']
                }
            ],
            find_error: [
                {
...
III. Kết thúc: Cảm ơn lại và xác nhận ngày bắt đầu`,
    ...
    {
        id: 'VSTEP-THX-03',
        name_vi: 'Cảm ơn sau khi nhận được quà tặng',
        name_en: 'Thank you letter after receiving a gift',
        prompt_vi: 'Viết thư cảm ơn sau khi nhận được món quà từ bạn bè',
        prompt_vi_short: 'Cảm ơn món quà',
        prompt_en: 'Write a thank you letter after receiving a gift from friends',
        topic: 'Personal',
        vocabulary: [
            { en: 'gift', vi: 'món quà', type: 'noun' },
            { en: 'thoughtful', vi: 'chu đáo', type: 'adjective' },
            { en: 'appreciate', vi: 'đánh giá cao', type: 'verb' },
            { en: 'kindness', vi: 'lòng tốt', type: 'noun' },
            { en: 'generous', vi: 'hào phóng', type: 'adjective' },
            { en: 'touched', vi: 'cảm động', type: 'adjective' },
            { en: 'surprise', vi: 'bất ngờ', type: 'noun' },
            { en: 'treasure', vi: 'trân trọng', type: 'verb' }
        ],
        sample_answer_en: `Dear [Friend's Name],

I am writing to express my heartfelt gratitude for the wonderful gift you gave me. Your thoughtfulness and kindness truly touched my heart, and I cannot thank you enough for such a generous gesture.

The gift was a complete surprise, and I was deeply moved by your consideration. It shows how well you know me and how much you care about our friendship. I will treasure this gift and the memories associated with it for years to come.

Your generosity has made me realize how lucky I am to have such wonderful friends in my life. I appreciate not only the gift itself but also the time and effort you put into choosing something so perfect for me.

Thank you once again for your kindness and for being such an amazing friend. I look forward to returning the favor and celebrating our friendship for many more years.

With warmest regards,
[Your Name]`,
        sample_answer_vi: `Gửi [Tên Bạn],

Tôi viết thư này để bày tỏ lòng biết ơn chân thành vì món quà tuyệt vời bạn đã tặng tôi. Sự chu đáo và lòng tốt của bạn thực sự đã chạm đến trái tim tôi, và tôi không thể cảm ơn đủ vì cử chỉ hào phóng như vậy.

Món quà là một bất ngờ hoàn toàn, và tôi rất cảm động vì sự quan tâm của bạn. Điều này cho thấy bạn hiểu tôi đến mức nào và bạn quan tâm đến tình bạn của chúng ta như thế nào. Tôi sẽ trân trọng món quà này và những kỷ niệm gắn liền với nó trong nhiều năm tới.

Sự hào phóng của bạn đã khiến tôi nhận ra mình may mắn như thế nào khi có những người bạn tuyệt vời như vậy trong cuộc sống. Tôi đánh giá cao không chỉ bản thân món quà mà còn cả thời gian và công sức bạn đã bỏ ra để chọn thứ gì đó hoàn hảo cho tôi.

Cảm ơn một lần nữa vì lòng tốt của bạn và vì đã là một người bạn tuyệt vời như vậy. Tôi mong muốn đền đáp lại và kỷ niệm tình bạn của chúng ta trong nhiều năm nữa.

Với lời chào ấm áp nhất,
[Tên của bạn]`,
        sample_outline_en: `I. Opening: Express gratitude for the gift
II. Body:
   - Describe how the gift made you feel
   - Mention the thoughtfulness behind it
   - Express appreciation for the friendship
III. Closing: Thank again and mention future friendship`,
        sample_outline_vi: `I. Mở đầu: Bày tỏ lòng biết ơn về món quà
II. Thân bài:
   - Mô tả cảm giác khi nhận quà
   - Đề cập sự chu đáo đằng sau nó
   - Bày tỏ sự đánh giá cao tình bạn
III. Kết thúc: Cảm ơn lại và đề cập tình bạn tương lai`,
        practice: {
            reorder: [
                {
                    words: [
                        { en: 'Your thoughtfulness', vi: 'Sự chu đáo của bạn' },
                        { en: 'and kindness', vi: 'và lòng tốt' },
                        { en: 'truly touched', vi: 'thực sự đã chạm đến' },
                        { en: 'my heart.', vi: 'trái tim tôi.' }
                    ],
                    answer: 'Your thoughtfulness and kindness truly touched my heart.'
                }
            ],
            fill_blank: [
                {
                    sentence: { en: 'I will ____ this gift for years to come.', vi: 'Tôi sẽ ____ món quà này trong nhiều năm tới.' },
                    missing_word: 'treasure',
                    options: ['treasure', 'keep', 'hold']
                }
            ],
            find_error: [
                {
                    sentence: { en: 'I appreciate not only the gift itself but also the time and effort you put in choosing something so perfect.', vi: 'Tôi đánh giá cao không chỉ bản thân món quà mà còn cả thời gian và công sức bạn đã bỏ ra để chọn thứ gì đó hoàn hảo.' },
                    error_word: 'in',
                    correct_word: 'into'
                }
            ],
            choose_phrase: [
                {
                    sentence: { en: 'I look forward to ____ the favor.', vi: 'Tôi mong muốn ____ lại ân huệ.' },
                    correct_phrase: 'returning',
            ...
            matching: [
                {
                    col_a: [
                        ...
                        { en: 'appreciate', vi: 'đánh giá cao' },
                        { en: 'treasure', vi: 'trân trọng' }
                    ],
                    col_b: [
                        { en: 'something given to someone', vi: 'thứ gì đó được tặng cho ai đó' },
                        { en: 'showing consideration for others', vi: 'thể hiện sự quan tâm đến người khác' },
                        { en: 'to value highly', vi: 'đánh giá cao' },
                        { en: 'to keep carefully', vi: 'giữ gìn cẩn thận' }
                    ],
                    correct_pairs: [
                        { left: 'gift', right: 'something given to someone' },
                        { left: 'thoughtful', right: 'showing consideration for others' },
                        { left: 'appreciate', right: 'to value highly' },
                        { left: 'treasure', right: 'to keep carefully' }
                    ]
                }
            ],
            drag_drop: [
                {
                    sentence_parts: [
                        { en: 'Your generosity', vi: 'Sự hào phóng của bạn' },
                        { en: 'has made me realize', vi: 'đã khiến tôi nhận ra' },
                        { en: 'how lucky', vi: 'may mắn như thế nào' },
                        { en: 'I am.', vi: 'tôi.' }
                    ],
                    correct_order: ['Your generosity', 'has made me realize', 'how lucky', 'I am.']
                }
            ]
        }
    }
...
// Continue with 17 more topics...
export const additionalVstepThankYouTopics: WritingSeed[] = [
    {
        id: 'VSTEP-THX-04',
        name_vi: 'Cảm ơn sau khi được giúp đỡ trong công việc',
        name_en: 'Thank you letter after receiving help at work',
        prompt_vi: 'Viết thư cảm ơn đồng nghiệp đã giúp đỡ trong dự án',
        prompt_vi_short: 'Cảm ơn sự giúp đỡ công việc',
        prompt_en: 'Write a thank you letter to a colleague who helped with a project',
        topic: 'Workplace',
        vocabulary: [
            { en: 'colleague', vi: 'đồng nghiệp', type: 'noun' },
            { en: 'assistance', vi: 'sự giúp đỡ', type: 'noun' },
            { en: 'collaboration', vi: 'sự hợp tác', type: 'noun' },
            { en: 'supportive', vi: 'hỗ trợ', type: 'adjective' },
            { en: 'teamwork', vi: 'làm việc nhóm', type: 'noun' },
            { en: 'appreciate', vi: 'đánh giá cao', type: 'verb' },
            { en: 'valuable', vi: 'có giá trị', type: 'adjective' },
            { en: 'professional', vi: 'chuyên nghiệp', type: 'adjective' }
        ],
        sample_answer_en: `Dear [Colleague's Name],

I wanted to take a moment to express my sincere gratitude for your invaluable assistance with the [Project Name] project. Your expertise and dedication were instrumental in helping us meet our deadline and achieve excellent results.

Your willingness to go above and beyond to help the team demonstrates true professionalism and teamwork. I particularly appreciated how you shared your knowledge and guided me through the challenging aspects of the project.

Working with you has been a pleasure, and I have learned so much from your experience and approach. Your collaborative spirit and positive attitude made the entire process much more enjoyable and productive.

Thank you again for your support and for being such a wonderful colleague. I look forward to future opportunities to work together.

Best regards,
[Your Name]`,
        sample_answer_vi: `Gửi [Tên Đồng Nghiệp],

Tôi muốn dành một chút thời gian để bày tỏ lòng biết ơn chân thành vì sự giúp đỡ vô giá của bạn trong dự án [Tên Dự Án]. Chuyên môn và sự tận tâm của bạn đã góp phần quan trọng giúp chúng ta đáp ứng thời hạn và đạt được kết quả xuất sắc.

Sự sẵn lòng vượt lên trên và vượt xa để giúp đỡ đội ngũ thể hiện tính chuyên nghiệp và tinh thần làm việc nhóm thực sự. Tôi đặc biệt đánh giá cao cách bạn chia sẻ kiến thức và hướng dẫn tôi qua những khía cạnh thách thức của dự án.

Làm việc với bạn là một niềm vui, và tôi đã học được rất nhiều từ kinh nghiệm và cách tiếp cận của bạn. Tinh thần hợp tác và thái độ tích cực của bạn đã làm cho toàn bộ quá trình trở nên thú vị và hiệu quả hơn nhiều.

Cảm ơn một lần nữa vì sự hỗ trợ của bạn và vì đã là một đồng nghiệp tuyệt vời như vậy. Tôi mong muốn những cơ hội tương lai để làm việc cùng nhau.

Trân trọng,
[Tên của bạn]`,
        sample_outline_en: `I. Opening: Express gratitude for assistance
II. Body:
   - Acknowledge their expertise and dedication
   - Mention specific ways they helped
   - Express appreciation for their collaboration
III. Closing: Thank again and mention future collaboration`,
        sample_outline_vi: `I. Mở đầu: Bày tỏ lòng biết ơn về sự giúp đỡ
II. Thân bài:
   - Thừa nhận chuyên môn và sự tận tâm của họ
   - Đề cập những cách cụ thể họ đã giúp
   - Bày tỏ sự đánh giá cao về sự hợp tác của họ
III. Kết thúc: Cảm ơn lại và đề cập sự hợp tác tương lai`,
        practice: {
            reorder: [
                {
                    words: [
                        { en: 'Your expertise', vi: 'Chuyên môn của bạn' },
                        { en: 'and dedication', vi: 'và sự tận tâm' },
                        { en: 'were instrumental', vi: 'đã góp phần quan trọng' },
                        { en: 'in helping us.', vi: 'trong việc giúp chúng ta.' }
                    ],
                    answer: 'Your expertise and dedication were instrumental in helping us.'
                }
            ],
            fill_blank: [
                {
                    sentence: { en: 'Your willingness to go above and beyond demonstrates true ____.', vi: 'Sự sẵn lòng vượt lên trên và vượt xa thể hiện tính ____ thực sự.' },
                    missing_word: 'professionalism',
                    options: ['professionalism', 'dedication', 'commitment']
                }
            ],
            find_error: [
                {
                    sentence: { en: 'I particularly appreciated how you shared your knowledge and guided me through the challenging aspects in the project.', vi: 'Tôi đặc biệt đánh giá cao cách bạn chia sẻ kiến thức và hướng dẫn tôi qua những khía cạnh thách thức của dự án.' },
                    error_word: 'in',
                    correct_word: 'of'
                }
            ],
            choose_phrase: [
                {
                    sentence: { en: 'I look forward to future opportunities to work ____.', vi: 'Tôi mong muốn những cơ hội tương lai để làm việc ____.' },
                    correct_phrase: 'together',
                    options: ['together', 'with you', 'collaboratively']
                }
            ],
            matching: [
                {
                    col_a: [
                        ...
                        { en: 'assistance', vi: 'sự giúp đỡ' },
                        { en: 'collaboration', vi: 'sự hợp tác' },
                        { en: 'teamwork', vi: 'làm việc nhóm' }
                    ],
                    col_b: [
                        { en: 'a person you work with', vi: 'người bạn làm việc cùng' },
                        { en: 'help or support', vi: 'giúp đỡ hoặc hỗ trợ' },
                        { en: 'working together', vi: 'làm việc cùng nhau' },
                        { en: 'cooperative effort', vi: 'nỗ lực hợp tác' }
                    ],
                    correct_pairs: [
                        { left: 'colleague', right: 'a person you work with' },
                        { left: 'assistance', right: 'help or support' },
                        { left: 'collaboration', right: 'working together' },
                        { left: 'teamwork', right: 'cooperative effort' }
                    ]
                }
            ],
            drag_drop: [
                {
                    sentence_parts: [
                        { en: 'Working with you', vi: 'Làm việc với bạn' },
                        { en: 'has been', vi: 'đã là' },
                        { en: 'a pleasure', vi: 'một niềm vui' },
                        { en: 'and I have learned so much.', vi: 'và tôi đã học được rất nhiều.' }
                    ],
                    correct_order: ['Working with you', 'has been', 'a pleasure', 'and I have learned so much.']
                }
            ]
        }
    }
    // ... Continue with 16 more topics following the same pattern
];

// Export all topics combined
export const allVstepThankYouTopics = [...vstepThankYouTopics, ...additionalVstepThankYouTopics];
