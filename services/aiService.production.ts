  ...
  properties: {
    errors: {
      ...
      items: {
        type: 'object' as any,
        properties: {
          error_text: { type: 'string' as any, description: "The incorrect part of the student's sentence." },
          correction: { type: 'string' as any, description: "The corrected version of that part." },
          explanation_vi: { type: 'string' as any, description: "A clear explanation of the error in Vietnamese." }
        },
        required: ['error_text', 'correction', 'explanation_vi']
      }
    },
    corrected_full_text: { type: 'string' as any, description: "The complete, corrected version of the student's text." },
    general_feedback_vi: { type: 'string' as any, description: "A brief, encouraging general feedback in Vietnamese. If the sentence is perfect, congratulate the user." }
  },
  ...
  properties: {
    suggestions: {
      ...
      items: {
        type: 'object' as any,
        properties: {
          suggestion_type: { type: 'string' as any, description: "The type of suggestion (e.g., 'Vocabulary', 'Sentence Structure', 'Clarity')." },
          original_text: { type: 'string' as any, description: "The part of the original text that could be improved." },
          suggested_text: { type: 'string' as any, description: "An improved or alternative phrasing." },
          explanation_vi: { type: 'string' as any, description: "An explanation in Vietnamese about why the suggestion improves the text." }
        },
        required: ['suggestion_type', 'original_text', 'suggested_text', 'explanation_vi']
      }
    },
    general_feedback_vi: { type: 'string' as any, description: "A brief, overall comment in Vietnamese on how to make the writing more impactful or natural." }
  },
...
const topicSchema = {
  type: Type.OBJECT,
  properties: {
    topic: { type: 'string' as any, description: "A short, engaging title for the writing topic in English." },
    prompt: { type: 'string' as any, description: "The full writing prompt or question for the user to answer, in English." }
  },
...
const templateSchema = {
  type: Type.OBJECT,
  properties: {
    title_en: { type: 'string' as any, description: "The English title for the template (e.g., 'Template for Opinion Essay')." },
    title_vi: { type: 'string' as any, description: "The Vietnamese title for the template (e.g., 'Dàn bài cho Dạng bài Quan điểm')." },
...
const vstepAnswerSchema = {
  type: Type.OBJECT,
  properties: {
    sample_answer_en: { type: 'string' as any, description: "A well-structured, high-quality sample speaking response in English for the VSTEP prompt." },
    sample_answer_vi: { type: 'string' as any, description: "A natural-sounding Vietnamese translation of the English sample answer." }
  },
...
const rewriteSchema = {
    type: Type.OBJECT,
    properties: {
        rewritten_text: { type: 'string' as any, description: "The rewritten version of the user's text." }
    },
...
const simpleWritingSeedSchema = {
    ...
    properties: {
        ...
        imageSeed: { type: 'string' as any, description: "A descriptive seed for an image generation model, e.g., 'a team of professionals in a modern office meeting room'." }
    },
