...
import { toeicPart6Test1_2019, Part6Passage, Part6Question } from '../data/toeic-part6-test1-2019-data';
...
// Extract passage1 (questions 131-134) from toeicPart6Test1_2019
const card131_134_Passage = toeicPart6Test1_2019.passages.find(p => p.id === 'toeic-part6-test1-2019-passage1');

const TOEICPart6Test1_2019_Card131_134: React.FC = () => {
  ...
  const handleComplete = useCallback(async () => {
    ...
    const lessonId = 'part6-test1-2019-card131-134';
    ...
    >
      ...
      {showBananaReward && bananaReward && (
        <SuperGrandBananaCelebration
          ...
          course="toeic"
          lessonId="part6-test1-2019-card131-134"
      ...
      <div className="sticky top-[96px] z-50 backdrop-blur-xl bg-white/90 border-b border-gray-200/50 shadow-sm mb-4 -mx-8 px-6 py-3">
        <div className="flex items-center justify-between gap-4 flex-wrap">
          ...
          <div className="flex items-center gap-3 flex-1 min-w-0">
            <button
              onClick={() => navigate('/toeic-part6-test-1-2019')}
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <button
              onClick={() => {
                localStorage.setItem('toeic-part6-test1-2019-card131-134-answers', JSON.stringify(selectedAnswers));
                navigate('/toeic-part6-test1-2019-card131-134-explanation', {
        ...
        <div className="resizable-container flex gap-0">
          ...
          >
            <div className="flex items-center justify-between mb-4 sticky top-0 bg-white/80 backdrop-blur-sm pb-3 z-10 border-b border-gray-200/50">
              ...
              {/* Answer Location Toggle - Compact Version */}
              <div className="flex items-center gap-2">
                <MapPinIcon className={`w-4 h-4 ${highlightAnswer ? 'text-blue-600' : 'text-gray-500'}`} />
                <span className={`text-xs font-medium ${highlightAnswer ? 'text-blue-700' : 'text-gray-600'}`}>
                  Định vị đáp án
                  </span>
              <button
                onClick={() => {
              ...
              >
                <span
                    className={`inline-block h-4 w-4 transform rounded-full bg-white transition-all duration-300 ${
                      highlightAnswer ? 'translate-x-4' : 'translate-x-0.5'
                  }`}
                />
              </button>
              </div>
...
export default TOEICPart6Test1_2019_Card131_134;
