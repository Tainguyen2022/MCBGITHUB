...
// Extract passage3 (questions 139-142) from toeicPart6Test1_2025
const card139_142_Passage = toeicPart6Test1_2025.passages.find(p => p.id === 'toeic-part6-test1-2025-passage3');

const TOEICPart6Test1_2025_Card139_142: React.FC = () => {
  const navigate = useNavigate();
  const { currentUser, updateUser } = useAuth();
  
  // Use only passage3 (questions 139-142)
  const selectedPassage = card139_142_Passage;
  
  // Collect questions from passage3 only
    ...
    >
      ...
      {showBananaReward && bananaReward && (
        <SuperGrandBananaCelebration
          ...
          course="toeic"
          lessonId="part6-test1-2025-card139-142"
...
export default TOEICPart6Test1_2025_Card139_142;
