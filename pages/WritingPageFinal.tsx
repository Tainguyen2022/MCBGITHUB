...
// Complete Writing Data matching your screenshots
const completeWritingData: WritingCategory[] = [
    {
        category_id: 'EASY',
        track_name_vi: 'Kỹ năng Nền tảng',
        subcategories: [
            {
                subcategory_id: 'foundation_basic',
                subcategory_name_vi: 'Câu đơn (S-V-O)',
                ...
                seeds: [
                    {
                        ...
                        prompt_vi_short: 'Câu đơn cơ bản',
                        ...
                        vocabulary: [
                            { en: 'team', vi: 'đội', type: 'noun' },
                            { en: 'developed', vi: 'đã phát triển', type: 'verb' },
                            { en: 'strategy', vi: 'chiến lược', type: 'noun' }
                        ],
                        practice: {
                            reorder: [
                                { words: [
                            ...
                            fill_blank: [
                                { 
                                    sentence: { en: 'The team _____ a new strategy.', vi: 'Đội _____ một chiến lược mới.' },
                                    missing_word: 'developed',
                                    options: ['developed', 'created', 'made', 'built']
                                }
                            ]
                        }
                    }
    ...
    },
    {
        ...
        subcategories: [
                ...
                seeds: [
                    {
                        ...
                        sample_answer_en: 'Dear Sarah, I hope this email finds you well. I wanted to thank you...',
            ...
            },
            {
                ...
                objective_vi: 'Viết email xin lỗi và giải thích',
                task_type: 'Task 1',
                track_id: 'VSTEP',
                level: 'B2',
                test_tags: ['VSTEP'],
            ...
            {
                subcategory_id: 'vstep_task1_request2',
            ...
            },
            {
                ...
                objective_vi: 'Viết email phản nàn về dịch vụ',
                task_type: 'Task 1',
                track_id: 'VSTEP',
                level: 'B2',
                test_tags: ['VSTEP'],
...
const WritingPageComplete: React.FC = () => {
    ...
    const writingData = useMemo(() => {
        try {
            const savedData = loadOrInitializeData(LOCAL_STORAGE_KEYS.WRITING_DATA, completeWritingData);
            return savedData.length > 0 ? savedData : completeWritingData;
        } catch (error) {
            console.warn('Using default writing data:', error);
            return completeWritingData;
        }
    }, []);
    ...
    const PracticeArea = () => {
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex flex-wrap gap-3 p-4 bg-gray-50 rounded-lg">
                                {exercise.words.map((word: any, index: number) => (
                                    <div key={index} className="bilingual-word-btn">
                    ...
                    return (
                        <div className="space-y-4">
                            ...
                            <div className="p-4 bg-gray-50 rounded-lg">
                                <p className="text-lg mb-4">{exercise.sentence.en}</p>
                ...
                return (
                    <div className="space-y-4">
                        ...
                        <textarea
                            ...
                            className="w-full h-40 p-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500"
        ...
        return (
            <div className="text-center py-8">
                <p className="text-gray-600">Chưa có bài tập cho dạng này</p>
            </div>
        );
    };
        ...
        <div className="writing-studio bg-slate-50 -m-8 px-4 pt-20 pb-12 min-h-screen">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex justify-center gap-4 mb-8">
                    <button className="btn-ai-pink px-6 py-3 rounded-lg font-semibold">
                        🎨 AI Gen Text
                    </button>
                    <button className="btn-ai-green px-6 py-3 rounded-lg font-semibold">
                        🖼️ AI Gen Image
                    </button>
                    <button className="btn-ai-blue px-6 py-3 rounded-lg font-semibold">
                        🔊 AI Gen Audio
                    </button>
                </div>
                ...
                {currentSeed ? (
                    <div className="practice-studio-grid">
                        ...
                        <div className="practice-list-panel">
                            <div className="mb-6">
                                <h4 className="font-bold text-gray-800 mb-2">Đề thi</h4>
                            ...
                            <div className="space-y-3">
                                {currentSeed.sample_answer_vi && (
                                    <button
                                        ...
                                        className="w-full text-left p-3 bg-green-50 border border-green-200 rounded-lg hover:bg-green-100"
                                    >
                        ...
                        <div className="practice-area-panel">
                            <div className="mb-4">
                                <h4 className="font-bold text-gray-800 mb-4">✍️ Khu vực luyện tập</h4>
...
export default WritingPageComplete;
