...
// Extract passage4 (questions 143-146) from toeicPart6Test1_2025
const card143_146_Passage = toeicPart6Test1_2025.passages.find(p => p.id === 'toeic-part6-test1-2025-passage4');

const TOEICPart6Test1_2025_Card143_146: React.FC = () => {
  const navigate = useNavigate();
  const { currentUser, updateUser } = useAuth();
  
  // Use only passage4 (questions 143-146)
  const selectedPassage = card143_146_Passage;
  
  // Collect questions from passage4 only
  ...
  const handleComplete = useCallback(async () => {
    ...
    const lessonId = 'part6-test1-2025-card143-146';
    ...
    >
      ...
      {showBananaReward && bananaReward && (
        <SuperGrandBananaCelebration
          ...
          course="toeic"
          lessonId="part6-test1-2025-card143-146"
          ...
          >
            ...
            <div className="mb-4 flex items-center justify-between p-4 bg-gray-50/50 rounded-2xl border border-gray-200/50 shadow-sm backdrop-blur-sm">
              ...
              <button
                ...
                title={highlightAnswer ? "Tắt highlight đáp án" : "Bật highlight đáp án"}
                aria-label={highlightAnswer ? "Tắt highlight đáp án" : "Bật highlight đáp án"}
              >
                <span
...
export default TOEICPart6Test1_2025_Card143_146;
